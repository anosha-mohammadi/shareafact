...
async function loadFacts() {
  const res = await fetch(
    "https://aibwgcyfxunwslnkyxrd.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFpYndnY3lmeHVud3Nsbmt5eHJkIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzI2NjEzNDcsImV4cCI6MTk4ODIzNzM0N30.8VHOv7ArWzd775lPEeYyrfRTVhys_fqlURA0q7127Ow",
      },
    }
  );
...
function createFactsList(dataArray) {
  ...
  const html = htmlArr.join(""); //convert to string
